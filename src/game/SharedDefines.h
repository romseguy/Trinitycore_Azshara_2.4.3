...
#define SPELL_ATTR_EX_STACK_FOR_DIFF_CASTERS	  0x00004000            // 14 according to google this is right :) but i dont think it does much in this core
...
#define SPELL_ATTR_EX_IGNORE_LOS				  0x10000000			// 28, google told me so.
