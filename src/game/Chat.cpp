...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "warden",                      SEC_ADMINISTRATOR, true,  &ChatHandler::HandleWardenDataReloadCommand,              "", NULL }, 
        { "dbc",                         SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadDBCCommand,                     "", NULL }, 
	...
	static ChatCommand commandTable[] =
    {
		...
		{ "ready",			SEC_PLAYER,         false, &ChatHandler::HandleReadyCommand,               "", NULL },
