...
enum MovementFlags
{
    ...
    MOVEFLAG_ROOT               = 0x00000800,               // Must not be set along with MOVEMENTFLAG_FORWARD | MOVEMENTFLAG_BACKWARD | MOVEMENTFLAG_STRAFE_LEFT | MOVEMENTFLAG_STRAFE_RIGHT -> client freeze
...
class Unit : public WorldObject
{
    public:
        ...
        SpellMissInfo SpellHitResult(Unit *pVictim, SpellEntry const *spell, bool canReflect = false, bool canMiss = true, bool WardCanReflect = false);
		...
		bool MonsterChargeByPath(Unit *target, uint32 speed, uint32 maxDistance, bool smoothPath, bool justcheck = false);
        ...
        void InterruptSpell(CurrentSpellTypes spellType, bool withDelayed = true, bool withInstant = true, bool fromspell = false);
		void InterruptSpellNotGrenade(CurrentSpellTypes spellType, bool withDelayed = true, bool withInstant = true, bool fromspell = false);
