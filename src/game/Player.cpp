...
void Player::RepopAtGraveyard()
{
	...
	// From > RemoveAurasByType(SPELL_AURA_BIND_SIGHT);
...
bool Player::LoadFromDB(uint32 guid, SqlQueryHolder *holder)
{
	...
	sWorld.BanAccount(BAN_IP, std::string(m_session->GetRemoteAddress()), "6h", "crasher", "CONSOLE");
        return false;
    }
...
void Player::HandleFallDamage(MovementInfo& movementInfo)
{
    ...
    if (movementInfo.GetFallTime() < 1600)
        return;
        ...
        !HasAuraType(SPELL_AURA_FLY) && !IsImmunedToDamage(SPELL_SCHOOL_MASK_NORMAL,true))
    {
        ...
        if (damageperc > 0)
        {
            ...
            // No more fall dmg in the arena and Bgs            
            BattleGround *bg = GetBattleGround();
            if(bg){
		if(bg->isArena()) {
                damage = 0;
...
void Player::AddGlobalCooldown(SpellEntry const *spellInfo, Spell const *spell)
{
    ...
    switch(spellInfo->Id) 
    {
       ...
       case 44047: 
          cdTime = 500;
          break;
       case 9421: // healthstone abuse with makros
       case 19012:
       case 19013:
       case 5510:
       case 19010:
       case 19011:
       case 43712: // PVE trinkets abuse with macros 60-69 lvl and 70 lvl shared cooldowns from wowhead
       case 43716:
       case 35166:
       case 51952:
       case 51953:
       ...
       case 24499:
       case 26166:
       case 44055: // PVP trinkets abuse with macros
       case 5405: // mage mana gem abuse with macros
       case 10052:
       case 10057:
       case 10058:
       case 27103:
