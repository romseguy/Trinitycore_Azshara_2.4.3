...
bool LoginQueryHolder::Initialize()
{
    ...
    res &= SetPQuery(PLAYER_LOGIN_QUERY_LOADFROM,
        ...
        "powerMana, powerRage, powerFocus, powerEnergy, powerHappiness, instance_id, nextProfessionReset "
...
void WorldSession::HandlePlayerLogin(LoginQueryHolder * holder)
{
    ...
    if ((sWorld.IsFFAPvPRealm() && !pCurrChar->isGameMaster() && !pCurrChar->HasFlag(PLAYER_FLAGS,PLAYER_FLAGS_RESTING))
            || (pCurrChar->IsFFAZone() && !pCurrChar->isGameMaster() && !pCurrChar->HasFlag(PLAYER_FLAGS,PLAYER_FLAGS_RESTING)))
