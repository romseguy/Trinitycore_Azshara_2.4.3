...
bool PlayerAlreadyHasTwoProfessions(Player* _plr)
{
    ...
    {
        _plr->GetSession()->SendNotification("Vous avez deja 2 metiers !");
        return true;
    }
...
bool GossipHello_global_npc_profession(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Alchimie",          GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Forge",             GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Enchantement",      GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+3, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Ingenierie",        GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+4, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Herboristerie",     GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+5, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Joaillerie",        GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+6, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Travail du cuir",   GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+7, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Minage",            GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+8, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Couture",           GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+9, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Depecage",          GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+10, WARN_RESET, 0, false);
...
bool GossipHello_alchemy_npc_profession(Player *player, Creature *_Creature)
{
    ...
    player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre alchimie.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1, WARN_RESET, 0, false);
    player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
    player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
    return true;
}
...
bool GossipHello_blacksmithing_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre forge.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_enchanting_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre enchantement.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+3, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_engineering_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre ingenierie.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+4, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_herbalism_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre herboristerie.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+5, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_jewelcrafting_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre joaillerie.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+6, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_leatherworking_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre travail du cuir.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+7, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_mining_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre minage.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+8, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_tailoring_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre couture.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+9, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
...
bool GossipHello_skinning_npc_profession(Player *player, Creature *_Creature)
{
    if (!player->isInCombat())
    {
        player->ADD_GOSSIP_ITEM_EXTENDED(0, "Apprendre depecage.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+10, WARN_RESET, 0, false);
        player->ADD_GOSSIP_ITEM(1, "Composants.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+11);
        player->PlayerTalkClass->SendGossipMenu(2, _Creature->GetGUID());
        return true;
    }
